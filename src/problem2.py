...
class Triangle(object):
    ...
    def area(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        length_of_side_AB = math.sqrt((self.b.x - self.a.x) ** 2 + (self.b.y - self.a.y) ** 2)
        length_of_side_AC = math.sqrt((self.c.x - self.a.x) ** 2 + (self.c.y - self.a.y) ** 2)
        length_of_side_BC = math.sqrt((self.b.x - self.c.x) ** 2 + (self.b.y - self.c.y) ** 2)
        S = 1/2 * (length_of_side_AB + length_of_side_AC + length_of_side_BC)
        A = math.sqrt(S *(S - length_of_side_BC) * (S - length_of_side_AC) * (S - length_of_side_AB))
        return round(A)
...
def get_largest_area(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        self.area(return_doubled_triangle())
